...
const after = "assert.ok(source !== html || source.indexOf('<section class=\\\"journal-history-section journal-panel') < source.indexOf('<div class=\\\"journal-overview-grid\\\"'));";
...
console.log('Final hierarchy ordering regression now checks Journal markup rather than CSS text.');
