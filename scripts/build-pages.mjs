        ...
        <section class="inventory-actions" aria-labelledby="inventory-actions-heading">
          <div class="inventory-actions__header">
            ...
            <p class="inventory-actions__hint">
              Create or restore a JSON backup of your inventory, journal, and customizer data stored in
              localStorage.
            </p>
          </div>
          <div class="inventory-actions__buttons">
            <button
              ...
              data-action-hint="Download a JSON file containing localStorage data for inventory, journal, and customizer."
            >
              <span class="inventory-button__glyph" aria-hidden="true">⤓</span>
              <span class="inventory-button__text">Export backup</span>
            </button>
            <button
              type="button"
              ...
              data-action-hint="Load a JSON backup into localStorage for inventory, journal, and customizer data."
            >
              <span class="inventory-button__glyph" aria-hidden="true">⤒</span>
              <span class="inventory-button__text">Import backup</span>
            </button>
            <input type="file" id="inventory-import" accept=".json,application/json,.csv,text/csv" hidden />
          </div>
          ...
          <section class="journal-actions journal-panel" aria-labelledby="journal-actions-heading">
            <div class="journal-actions__header">
              ...
              <p class="journal-actions__hint">
                Create or restore a JSON backup of your inventory, journal, and customizer data stored in localStorage.
              </p>
            </div>
