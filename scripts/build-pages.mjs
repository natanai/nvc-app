            ...
            <details class="inventory-bluesky-panel">
              ...
              <div class="inventory-bluesky-panel__content">
                ...
                <section class="inventory-auth-panel" aria-label="Bluesky sign-in">
                  ...
                  <p class="inventory-auth-warning">
                    The strategy feed uses Bluesky follow visibility to show accounts you follow. If your Bluesky
                    “Logged-out visibility” setting hides your follows, the feed may look empty unless you enable that
                    setting or use authenticated access.
                  </p>
                </section>
