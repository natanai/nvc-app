...
function renderSuggestions() {
  ...
  if (feelingsSwitch) {
    ...
    feelingsSwitch.textContent = isMet ? 'Met' : 'Unmet';
    feelingsSwitch.setAttribute(
      'aria-label',
      isMet
        ? 'Showing feelings for when needs are met. Activate to view unmet feelings.'
        : 'Showing feelings for when needs aren’t met. Activate to view met feelings.',
    );
  }
